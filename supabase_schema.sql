...
-- ----------------------------------------------------------------
-- 2026-08-16 추가: 한반도 밖 좌표 저장 거부  ★ 운영 DB에 적용 완료·검증 완료
-- ----------------------------------------------------------------
-- 검증 결과(공개 키로 실제 INSERT 시도):
--   36.64N/127.49E(청주) → 201 통과   ← 정상 가입 경로가 막히지 않음도 같이 확인됨
--   40.5N / 140.0E / 0,0 → 401 거부 ("violates row-level security policy")
-- ----------------------------------------------------------------
